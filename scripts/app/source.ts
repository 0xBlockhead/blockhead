...
export const sourceBindingCompatibility = [
	...
	{ wireProtocol: WireProtocol.JsonRpc2, apiFamilies: [ApiFamily.AcpProtocol], endpointKinds: [SourceEndpointKind.LocalProcess], operationGroups: true, artifactKinds: true },
	...
	{ wireProtocol: WireProtocol.JsonRpc2, apiFamilies: [ApiFamily.McpProtocol], endpointKinds: [SourceEndpointKind.HttpUrl, SourceEndpointKind.LocalProcess], operationGroups: true, artifactKinds: true },
