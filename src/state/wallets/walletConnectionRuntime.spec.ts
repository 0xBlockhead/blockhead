	...
	it('writes wallet and session-action create/update local mutations through the sanctioned boundary', async () => {
		...
		const context = {
			...
			entityFieldCollections: {
				[EntityType.BlockheadSession]: {
					[entityFieldAddressKey(EntityType.BlockheadSession, [], '$$actions')]: fieldCollection(),
					[entityFieldAddressKey(EntityType.BlockheadSession, [], 'name')]: fieldCollection(),
					[entityFieldAddressKey(EntityType.BlockheadSession, [], 'status')]: fieldCollection(),
					[entityFieldAddressKey(EntityType.BlockheadSession, [], 'createdAt')]: fieldCollection(),
					[entityFieldAddressKey(EntityType.BlockheadSession, [], 'updatedAt')]: fieldCollection(),
				},
				[EntityType.BlockheadSessionAction]: {
					[entityFieldAddressKey(EntityType.BlockheadSessionAction, [], '$session')]: fieldCollection(),
					[entityFieldAddressKey(EntityType.BlockheadSessionAction, [], 'indexInSequence')]: fieldCollection(),
					[entityFieldAddressKey(EntityType.BlockheadSessionAction, [], 'actionType')]: fieldCollection(),
					[entityFieldAddressKey(EntityType.BlockheadSessionAction, [], 'actionParams')]: fieldCollection(),
					[entityFieldAddressKey(EntityType.BlockheadSessionAction, [], 'createdAt')]: fieldCollection(),
					[entityFieldAddressKey(EntityType.BlockheadSessionAction, [], 'updatedAt')]: fieldCollection(),
				},
				[EntityType._Global]: {
					[entityFieldAddressKey(EntityType._Global, [], '$$actors')]: fieldCollection(),
					[entityFieldAddressKey(EntityType._Global, [], '$$blockheadSessions')]: fieldCollection(),
					[entityFieldAddressKey(EntityType._Global, [], '$$blockheadWallets')]: fieldCollection(),
					[entityFieldAddressKey(EntityType._Global, [], '$$blockheadWalletAccounts')]: fieldCollection(),
				...
				[EntityType.BlockheadWalletAccount]: {
					[entityFieldAddressKey(EntityType.BlockheadWalletAccount, [], '$network')]: fieldCollection(),
					[entityFieldAddressKey(EntityType.BlockheadWalletAccount, [], 'address')]: fieldCollection(),
					[entityFieldAddressKey(EntityType.BlockheadWalletAccount, [], 'capabilities')]: fieldCollection(),
				},
				[EntityType.BlockheadWalletConnection]: {
					...
					[entityFieldAddressKey(EntityType.BlockheadWalletConnection, [], '$$connectedAccounts')]: fieldCollection(),
