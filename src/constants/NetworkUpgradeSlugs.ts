 ...
 */
export const ethereumNetworkMarketingNetworkUpgradeSlugRows = [
 ...
 */
export const ethereumNetworkMarketingNetworkExecutionUpgradeSlugRows = [
 ...
 */
export const ethereumNetworkMarketingNetworkConsensusUpgradeSlugRows = [
...
export const ethereumNetworkMarketingNetworkUpgradeSlugByUpgradeId = Object.fromEntries(
	ethereumNetworkMarketingNetworkUpgradeSlugRows.map((row) => [
		row.upgradeId,
		row,
	]),
)
...
export const networkExecutionUpgradeSlugByUpgradeId = Object.fromEntries(
	ethereumNetworkMarketingNetworkExecutionUpgradeSlugRows.map((row) => [
		row.upgradeId,
		row,
	]),
)
...
export const networkConsensusUpgradeSlugByUpgradeId = Object.fromEntries(
	ethereumNetworkMarketingNetworkConsensusUpgradeSlugRows.map((row) => [
		row.upgradeId,
		row,
	]),
)
