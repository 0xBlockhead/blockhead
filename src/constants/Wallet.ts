...
export enum WalletTransportKind {
	...
	PostMessage = 'post-message',
	NearSelectorModule = 'near-selector-module',
...
export enum WalletCapability {
	...
	SignStarknetTypedData = 'sign-starknet-typed-data',
...
export const walletConnectionMethods = [
	...
	},
	{
		...
		networkNamespaces: [NetworkNamespace.Solana, NetworkNamespace.Sui],
...
const walletTransportKinds = [
	...
	{ transportKind: WalletTransportKind.NearSelectorModule, label: 'NEAR Wallet Selector module' },
...
const walletCapabilities = [
	...
	{ capability: WalletCapability.SignStarknetTypedData, label: 'Sign Starknet typed data' },
