...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyEntitiesSelection<EntityType.HederaNetworkStake_Timestamp>
...
>
	...
	{#snippet Item({ item: hederaNetworkStakeTimestamp })}
		...
		<EntityView
			entityType={EntityType.HederaNetworkStake_Timestamp}
			entitySelector={hederaNetworkStakeTimestamp[EntityMetaKey.Selector]}
