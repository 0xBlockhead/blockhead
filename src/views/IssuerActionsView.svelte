...
<script lang="ts">
	...
	let {
		...
		id = 'IssuerActions-list',
		...EntitiesListProps
	}: WithRest<
		{
			selection: RegisteredEntityProxyEntitiesSelection<EntityType.IssuerAction>
...
>
	...
	{#snippet Item({ item: issuerAction })}
		...
		<EntityView
			entityType={EntityType.IssuerAction}
			entitySelector={issuerAction[EntityMetaKey.Selector]}
