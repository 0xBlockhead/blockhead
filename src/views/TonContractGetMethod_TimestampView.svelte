...
<script lang="ts">
	...
	let {
		...
		{
			selection: EntityProxyResource<typeof schema, EntityType.TonContractGetMethod_Timestamp>
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.TonContractGetMethod_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
>
	{#snippet Title()}
		<ResourceBoundary resource={tonContractGetMethodTimestamp}>
			{#snippet Pending()}
				{title || 'TON contract get method timestamp'}
			{/snippet}
	...
	{#snippet Content({ open: contentOpen })}
		<dl data-column-item="center">
			...
			>
				...
				{#snippet children(entity)}
					{@const resolvedEntity = { ...pendingEntity, ...entity }}
					{@const methodId = resolvedEntity.methodId}
					{#if methodId !== undefined && methodId !== null}
						<div>
							<dt>method ID</dt>
							<dd>
			...
			>
				{#snippet Pending()}
					...
					{#if resultHash !== undefined && resultHash !== null}
						<div>
							<dt>result hash</dt>
							<dd>
								<TruncatedValue value={String((resultHash) ?? '')} />
							</dd>
						</div>
					{/if}
				{/snippet}
				...
				{#snippet children(entity)}
					{@const resolvedEntity = { ...pendingEntity, ...entity }}
					{@const resultHash = resolvedEntity.resultHash}
					{#if resultHash !== undefined && resultHash !== null}
						<div>
							<dt>result hash</dt>
							<dd>
			...
			>
				...
				{#snippet children(entity)}
					{@const resolvedEntity = { ...pendingEntity, ...entity }}
					{@const blockSeqno = resolvedEntity.blockSeqno}
					{#if blockSeqno !== undefined && blockSeqno !== null}
						<div>
							<dt>block seqno</dt>
							<dd>
