...
<script lang="ts">
	...
	let {
		...
		...EntityViewProps
	}: Omit<EntitySelectionViewProps<EntityType.AgentIdentityClaim>, 'prefetched'> = $props()
	...
	const titleFallback = $derived(selection.entitySelector.identityKind || 'agent identity claim')
	...
	{#snippet Content()}
		<dl data-column-item="center">
			...
			<div>
				<dt>identity kind</dt>
				<dd>
					{selection.entitySelector.identityKind}
				</dd>
			</div>
