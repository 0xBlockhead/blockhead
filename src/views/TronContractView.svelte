...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.TronContract>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
>
	...
	{#snippet Content({ open: contentOpen })}
		<dl data-column-item="center">
			...
			<ResourceBoundary
				resource={
					selection[EntityProxyField]<EntityType.TronAccount, false>('$account', {
						sources: [
			...
			<ResourceBoundary
				resource={
					selection[EntityProxyField]<EntityType.TronAccount, false>('$creator', {
						sources: [
							Source.TronScan_Rest,
						],
					})
			...
			<ResourceBoundary
				resource={
					selection[EntityProxyField]<EntityType.TronTransaction, false>('$creationTransaction', {
						sources: [
							Source.TronScan_Rest,
						],
					})
