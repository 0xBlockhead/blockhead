...
<script lang="ts">
	...
	let {
		...
		{
			selection: EntityProxyResource<typeof schema, EntityType.BlockheadLocalMediaIngest>
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.BlockheadLocalMediaIngest>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
