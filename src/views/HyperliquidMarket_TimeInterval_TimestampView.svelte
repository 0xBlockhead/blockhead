...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.HyperliquidMarket_TimeInterval_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
		...
		<dl data-column-item="center">
			...
			<div>
				...
				<dd>
					...
					>
						{#snippet Pending()}
							{@const marketKey = pendingEntity.marketKey}
			...
			>
				{#snippet Pending()}
					{@const volume = pendingEntity.volume}
			...
			>
				{#snippet Pending()}
					{@const tradeCount = pendingEntity.tradeCount}
