...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyEntitiesResource<EntityType.HyperliquidBlock>
			title?: string
...
>
	...
	{#snippet Item({ item: hyperliquidBlock })}
		...
		{@const selection = select(EntityType.HyperliquidBlock, hyperliquidBlock[EntityMetaKey.Selector], { sources: collectionSelection.sources })}
