...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.BlockheadIntentOrder>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
>
	...
	{#snippet Content({ open: contentOpen })}
		<dl data-column-item="center">
			...
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.BlockheadIntentQuote, false>('$quote')}
			>
	...
	{#snippet Details({ open: detailsOpen })}
		{#if detailsOpen}
			<BlockheadIntentOrder_TimestampsView
				selection={selection[EntityProxyField]<EntityType.BlockheadIntentOrder_Timestamp>('$$timestamps')}
				title='timestamps'
