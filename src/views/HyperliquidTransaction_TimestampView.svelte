...
<script lang="ts">
	...
	let {
		...
		{
			selection: EntityProxyResource<typeof schema, EntityType.HyperliquidTransaction_Timestamp>
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.HyperliquidTransaction_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
>
	{#snippet Title()}
		<ResourceBoundary resource={hyperliquidTransactionTimestamp}>
			{#snippet Pending()}
				{title || 'hyperliquid transaction timestamp'}
			{/snippet}
