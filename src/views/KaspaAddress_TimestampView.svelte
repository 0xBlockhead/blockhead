...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyResource<EntityType.KaspaAddress_Timestamp>
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.KaspaAddress_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
