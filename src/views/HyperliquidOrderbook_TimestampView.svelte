...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.HyperliquidOrderbook_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
		...
		<dl data-column-item="center">
			...
			<div>
				...
				<dd>
					...
					>
						{#snippet Pending()}
							{@const bookKey = selection.entitySelector.bookKey ?? prefetched.bookKey}
			...
			>
				{#snippet Pending()}
					{@const nSigFigs = prefetched.nSigFigs}
			...
			>
				{#snippet Pending()}
					{@const mantissa = prefetched.mantissa}
			...
			>
				{#snippet Pending()}
					{@const depthLimit = prefetched.depthLimit}
