...
<script lang="ts">
	...
	let {
		...
		{
			selection: EntityProxyResource<typeof schema, EntityType.TronWitness_Timestamp>
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.TronWitness_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
