...
>
	...
	{#snippet Content({ open: contentOpen })}
		<dl data-column-item="center">
			...
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.XrplAccount, false>('$account')}
			>
			...
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.XrplAccount, false>('$issuerAccount')}
			>
				{#snippet children(xrplAccount)}
					{#if xrplAccount != null && xrplAccount[EntityMetaKey.Selector] != null}
						<div>
