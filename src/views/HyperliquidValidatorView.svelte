...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.HyperliquidValidator>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
		...
		<dl data-column-item="center">
			...
			<div>
				...
				<dd>
					...
					>
						{#snippet Pending()}
							{@const validator = selection.entitySelector.validator ?? prefetched.validator}
