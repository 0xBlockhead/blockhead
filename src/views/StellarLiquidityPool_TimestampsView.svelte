...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyEntitiesSelection<EntityType.StellarLiquidityPool_Timestamp>
...
<EntitiesList
	...
	{countResource}
	getResourceItems={(stellarLiquidityPoolTimestamps) => [...new Map(stellarLiquidityPoolTimestamps.values.map((stellarLiquidityPoolTimestamp) => [stellarLiquidityPoolTimestamp[EntityMetaKey.SelectorKey], stellarLiquidityPoolTimestamp])).values()]}
...
>
	...
	{#snippet Item({ item: stellarLiquidityPoolTimestamp })}
		...
		<EntityView
			entityType={EntityType.StellarLiquidityPool_Timestamp}
			entitySelector={stellarLiquidityPoolTimestamp[EntityMetaKey.Selector]}
			layout={EntityLayout.Summary}
			open={false}
			showTypeAnnotation={false}
		>
			{#snippet Title()}
				{'stellar liquidity pool timestamp'}
			{/snippet}
		</EntityView>
	{/snippet}
</EntitiesList>
