...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyResource<EntityType.SuiObject>
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.SuiObject>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
>
	{#snippet Title()}
		<ResourceBoundary resource={suiObject}>
			{#snippet Pending()}
				{title || 'Sui object'}
			{/snippet}
