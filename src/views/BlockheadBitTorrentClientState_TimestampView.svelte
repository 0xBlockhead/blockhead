...
<script lang="ts">
	...
	let {
		...
		...EntityViewProps
	}: Omit<EntitySelectionViewProps<EntityType.BlockheadBitTorrentClientState_Timestamp>, 'prefetched'> = $props()
	...
	href={
		href === undefined ?
			resolve(
				...
				{
					clientId: selection.entitySelector.$clientState.clientId,
	...
	{#snippet Value()}
		<ResourceBoundary resource={blockheadBitTorrentClientStateTimestamp}>
			{#snippet children(entity)}
				{(entity.clientVersion ?? '') || String(selection.entitySelector.timestampMs)}
			{/snippet}
		</ResourceBoundary>
	{/snippet}
