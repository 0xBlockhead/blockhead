...
>
	...
	{#snippet Content({ open: contentOpen })}
		...
		<dl data-column-item="center">
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.Account, false>('$fromAccount')}
			>
			...
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.Account, false>('$toAccount')}
			>
				{#snippet children(account)}
					{#if account != null && account[EntityMetaKey.Selector] != null}
						<div>
			...
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.EvmCoinInstance, false>('$token')}
			>
