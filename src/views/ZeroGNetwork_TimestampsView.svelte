<script lang="ts">
	...
	let {
		...
		{
			entityFieldReference: EntityFieldReference<typeof schema, EntityType.ZeroGNetwork_Timestamp>
			title?: string
			open?: boolean
			id: string
			href?: string
	...
	{#snippet body()}
		{#if open}
			...
			{@const timestamps = derive(
				parent,
				(parent): readonly Entity<typeof schema, EntityType.ZeroGNetwork_Timestamp>[] => (
