...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.HyperliquidVault>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
		...
		<dl data-column-item="center">
			...
			<div>
				...
				<dd>
					...
					>
						{#snippet Pending()}
							{@const vaultAddress = selection.entitySelector.vaultAddress ?? prefetched.vaultAddress}
			...
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.HyperliquidAccount, false>('$leader')}
			>
