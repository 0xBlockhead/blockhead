...
<script lang="ts">
	...
	let {
		...
		{
			selection: EntityProxyEntitiesResource<typeof schema, EntityType.GitCommit>
			title?: string
	...
	>
		{#snippet children(gitCommits)}
			...
			>
				...
				{#snippet Item({ item: gitCommit }: { item: SubscribeEntityReferenceResult<typeof schema, EntityType.GitCommit> })}
