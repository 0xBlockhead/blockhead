...
<EntitiesList
	...
	getResourceItems={(globalAiArtifactCatalogs) => [...new Map(globalAiArtifactCatalogs.values.map((globalAiArtifactCatalog) => [globalAiArtifactCatalog[EntityMetaKey.SelectorKey], globalAiArtifactCatalog])).values()]}
