<script lang="ts">
	...
	let {
		...
		{
			entityFieldReference: EntityFieldReference<typeof schema, EntityType.HyperliquidValidator>
			title?: string
			open?: boolean
			id: string
			href?: string
	...
	{#snippet body()}
		{#if open}
			...
			{@const validators = derive(
				parent,
				(parent): readonly Entity<typeof schema, EntityType.HyperliquidValidator>[] => (
