		...
		<dl data-column-item="center">
			...
			<div>
				...
				<dd>
					...
					>
						{#snippet Pending()}
							{@const accountRole = prefetched.accountRole}
			...
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.HyperliquidAccount, false>('$masterAccount')}
			>
			...
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.HyperliquidAccount, false>('$agentAccount')}
			>
				{#snippet children(hyperliquidAccount)}
					{#if hyperliquidAccount != null && hyperliquidAccount[EntityMetaKey.Selector] != null}
						<div>
