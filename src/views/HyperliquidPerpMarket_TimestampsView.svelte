...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyEntitiesSelection<EntityType.HyperliquidPerpMarket_Timestamp>
...
>
	...
	{#snippet Item({ item: hyperliquidPerpMarketTimestamp })}
		...
		<EntityView
			entityType={EntityType.HyperliquidPerpMarket_Timestamp}
			entitySelector={hyperliquidPerpMarketTimestamp[EntityMetaKey.Selector]}
			layout={EntityLayout.Summary}
			open={false}
			showTypeAnnotation={false}
		>
			{#snippet Title()}
				{'hyperliquid perp market timestamp'}
			{/snippet}
		</EntityView>
	{/snippet}
</EntitiesList>
