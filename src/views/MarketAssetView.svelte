...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.MarketAsset>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
<EntityView
	...
	href={
		href ?? (pendingEntity.kind !== undefined && pendingEntity.assetKey !== undefined ? resolve('/market-asset/[kind=stringSegment]/[assetKey=stringSegment]', {
