...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.BlockheadActionReadinessCheck_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
	...
	const blockheadActionReadinessCheckTimestamp = $derived(selection({
		sources: [
				...
				{#snippet Pending()}
					...
					{#if observedAmount !== undefined && observedAmount !== null}
						<div>
							...
							<dd>
								<NumberValue value={Number(observedAmount)} />
							</dd>
						</div>
					{/if}
				{/snippet}
				...
				{#snippet Pending()}
					...
					{#if deficitAmount !== undefined && deficitAmount !== null}
						<div>
							...
							<dd>
								<NumberValue value={Number(deficitAmount)} />
							</dd>
						</div>
					{/if}
				{/snippet}
