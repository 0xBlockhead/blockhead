...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyResource<EntityType.SuiRegulatedCoinState_Timestamp>
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.SuiRegulatedCoinState_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
