...
<script lang="ts">
	...
	let {
		...
		{
			selection: EntityProxyResource<typeof schema, EntityType.BlockheadCashuMintQuote_Timestamp>
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.BlockheadCashuMintQuote_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
