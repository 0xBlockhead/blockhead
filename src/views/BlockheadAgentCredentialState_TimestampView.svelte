...
<script lang="ts">
	...
	let {
		...
		...EntityViewProps
	}: Omit<EntitySelectionViewProps<EntityType.BlockheadAgentCredentialState_Timestamp>, 'prefetched'> = $props()
	...
	const blockheadAgentCredentialStateTimestamp = $derived(viewSelection({
		fields: {
			status: true,
		},
	}))
	...
	href={
		href === undefined ?
			resolve(
				...
				{
					credentialId: selection.entitySelector.$credential.credentialId,
...
>
	...
	{#snippet Content()}
		<dl data-column-item="center">
			...
			<ResourceBoundary
				resource={blockheadAgentCredentialStateTimestamp}
			>
				{#snippet children(entity)}
