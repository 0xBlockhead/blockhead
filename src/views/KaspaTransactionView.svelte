...
<script lang="ts">
	...
	let {
		...
		...EntityViewProps
	}: Omit<EntitySelectionViewProps<EntityType.KaspaTransaction>, 'prefetched'> = $props()
	...
	{#snippet Content()}
		...
		<dl data-column-item="center">
			...
			<div>
				...
				<dd>
					<ResourceBoundary
						resource={viewSelection.blockHashes}
					>
						{#snippet children(blockHashes)}
							{blockHashes.values.join(', ')}
						{/snippet}
					</ResourceBoundary>
				</dd>
			</div>
