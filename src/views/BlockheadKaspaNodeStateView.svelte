...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.BlockheadKaspaNodeState>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
	...
	{#snippet Details({ open: detailsOpen })}
		{#if detailsOpen}
			<BlockheadKaspaNodeState_TimestampsView
				selection={selection[EntityProxyField]<EntityType.BlockheadKaspaNodeState_Timestamp>('$$timestamps')}
				title='timestamps'
