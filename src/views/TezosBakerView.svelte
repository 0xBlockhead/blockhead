...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyResource<EntityType.TezosBaker>
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.TezosBaker>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
>
	{#snippet Title()}
		<ResourceBoundary resource={tezosBaker}>
			{#snippet Pending()}
				{title || 'tezos baker'}
			{/snippet}
