...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.FarcasterNetwork>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
>
	...
	{#snippet TypeAnnotationTooltip()}
		<p>
			Farcaster profiles, channels, and casts: FID plus cast-hash identity with hub feeds from configured Farcaster sources.
		</p>
	{/snippet}
