...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyEntitiesSelection<EntityType.TronWitness_Timestamp>
...
>
	...
	{#snippet Item({ item: tronWitnessTimestamp })}
		...
		<EntityView
			entityType={EntityType.TronWitness_Timestamp}
			entitySelector={tronWitnessTimestamp[EntityMetaKey.Selector]}
			layout={EntityLayout.Summary}
			open={false}
			showTypeAnnotation={false}
		>
			{#snippet Title()}
				{'tron witness timestamp'}
			{/snippet}
		</EntityView>
	{/snippet}
</EntitiesList>
