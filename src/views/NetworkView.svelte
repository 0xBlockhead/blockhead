...
>
	...
	{#snippet Content({ open: contentOpen })}
			...
			{#if pendingEntity.executionModels != null && pendingEntity.executionModels.values.includes('Evm')}
				...
				>
					{#snippet Applicable(projection)}
						...
						{#if pendingEntity.consensusProtocol === 'EthereumBeacon'}
							<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'ZeroG'}
			<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'Lightning'}
			<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'Hedera'}
			<ProjectionBoundary
	...
	{#snippet Details()}
		...
		{#if pendingEntity.executionModels != null && pendingEntity.executionModels.values.includes('PolkadotRuntime')}
			<ProjectionBoundary
		...
		{#if pendingEntity.executionModels != null && pendingEntity.executionModels.values.includes('SolanaRuntime')}
			<ProjectionBoundary
		...
		{#if pendingEntity.ledgerModels != null && pendingEntity.ledgerModels.values.includes('Utxo')}
			<ProjectionBoundary
		...
		{#if pendingEntity.executionModels != null && pendingEntity.executionModels.values.includes('ZcashShielded')}
			<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'Bittensor'}
			<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'Filecoin'}
			<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'Near'}
			<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'Monero'}
			<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'Cardano'}
			<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'Tron'}
			<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'Ton'}
			<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'Xrpl'}
			<ProjectionBoundary
		...
		{#if pendingEntity.namespace === 'Hyperliquid'}
			<ProjectionBoundary
