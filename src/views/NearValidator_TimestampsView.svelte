...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyEntitiesResource<EntityType.NearValidator_Timestamp>
			title?: string
...
>
	...
	{#snippet Item({ item: nearValidatorTimestamp })}
		...
		{@const selection = select(EntityType.NearValidator_Timestamp, nearValidatorTimestamp[EntityMetaKey.Selector], { sources: collectionSelection.sources })}
