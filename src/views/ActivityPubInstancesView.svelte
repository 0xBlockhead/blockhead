		...
		<EntityView
			...
			href={
				resolve(
					...
					{
						instanceOrigin: encodeURIComponent(String(activityPubInstanceSelector.instanceOrigin)),
					}
				)
			}
		>
			{#snippet Title()}
				{String(activityPubInstanceSelector.instanceOrigin) || 'ActivityPub instance'}
			{/snippet}
		</EntityView>
	{/snippet}
</EntitiesList>
