...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.BitTorrentDhtLookup_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
				...
				{#snippet Pending()}
					...
					{#if queriedNodeCount !== undefined && queriedNodeCount !== null}
						<div>
							...
							<dd>
								<NumberValue value={Number(queriedNodeCount)} />
							</dd>
						</div>
					{/if}
				{/snippet}
				...
				{#snippet Pending()}
					...
					{#if responsiveNodeCount !== undefined && responsiveNodeCount !== null}
						<div>
							...
							<dd>
								<NumberValue value={Number(responsiveNodeCount)} />
							</dd>
						</div>
					{/if}
				{/snippet}
