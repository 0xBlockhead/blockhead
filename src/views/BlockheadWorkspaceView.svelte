...
<script lang="ts">
	...
	let {
		...
		{
			selection: EntityProxyResource<typeof schema, EntityType.BlockheadWorkspace>
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.BlockheadWorkspace>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
