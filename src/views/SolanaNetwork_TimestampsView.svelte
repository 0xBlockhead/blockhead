<script lang="ts">
	...
	let {
		...
		{
			entityFieldReference: EntityFieldReference<typeof schema, EntityType.SolanaNetwork_Timestamp>
			title?: string
			open?: boolean
			id: string
			href?: string
	...
	{#snippet body()}
		{#if open}
			...
			{@const timestamps = derive(
				parent,
				(parent): readonly Entity<typeof schema, EntityType.SolanaNetwork_Timestamp>[] => (
