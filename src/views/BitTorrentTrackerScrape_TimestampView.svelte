...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.BitTorrentTrackerScrape_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
				...
				{#snippet Pending()}
					...
					{#if complete !== undefined && complete !== null}
						<div>
							<dt>complete</dt>
							<dd>
								<NumberValue value={Number(complete)} />
							</dd>
						</div>
					{/if}
				{/snippet}
				...
				{#snippet Pending()}
					...
					{#if incomplete !== undefined && incomplete !== null}
						<div>
							<dt>incomplete</dt>
							<dd>
								<NumberValue value={Number(incomplete)} />
							</dd>
						</div>
					{/if}
				{/snippet}
