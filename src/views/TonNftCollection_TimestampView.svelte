...
<script lang="ts">
	...
	let {
		...
		...EntityViewProps
	}: Omit<EntitySelectionViewProps<EntityType.TonNftCollection_Timestamp>, 'prefetched'> = $props()
...
>
	{#snippet Content()}
		<dl data-column-item="center">
			...
			>
				{#snippet children(entity)}
					{@const nextItemIndex = entity.nextItemIndex}
			...
			>
				{#snippet children(entity)}
					{@const itemCount = entity.itemCount}
					{#if itemCount != null}
						<div>
							<dt>item count</dt>
							<dd>
