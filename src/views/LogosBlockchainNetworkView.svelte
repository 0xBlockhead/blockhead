...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.LogosBlockchainNetwork>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
	...
	{#snippet Details({ open: detailsOpen })}
		{#if detailsOpen}
			<LogosBlockchainNetwork_TimestampsView
				selection={selection[EntityProxyField]<EntityType.LogosBlockchainNetwork_Timestamp>('$$timestamps')}
				title='Timestamps'
