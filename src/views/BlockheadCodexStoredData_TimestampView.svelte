...
<script lang="ts">
	...
	let {
		...
		...EntityViewProps
	}: Omit<EntitySelectionViewProps<EntityType.BlockheadCodexStoredData_Timestamp>, 'prefetched'> = $props()

	const storedData = $derived(selection.entitySelector.$storedData)
