...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.BlockheadSwapIntent>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
>
	...
	{#snippet Content({ open: contentOpen })}
		<dl data-column-item="center">
			...
			>
				{#snippet Pending()}
					{@const assetInCaip19 = pendingEntity.assetInCaip19}
			...
			>
				{#snippet Pending()}
					{@const assetOutCaip19 = pendingEntity.assetOutCaip19}
		...
		<dl data-column-item="center">
			...
			>
				{#snippet Pending()}
					{@const tokenInAddress = pendingEntity.tokenInAddress}
			...
			>
				{#snippet Pending()}
					{@const tokenOutAddress = pendingEntity.tokenOutAddress}
