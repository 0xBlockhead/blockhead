...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.BlockheadLogosBlockchainWalletKeyState>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
	...
	{#snippet Details({ open: detailsOpen })}
		{#if detailsOpen}
			<BlockheadLogosBlockchainWalletKeyState_TimestampsView
				selection={selection[EntityProxyField]<EntityType.BlockheadLogosBlockchainWalletKeyState_Timestamp>('$$timestamps')}
				title='timestamps'
