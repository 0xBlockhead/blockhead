...
>
	...
	{#snippet Details({ open: detailsOpen })}
		{@const blockheadBridgeIntentBlockheadIntentQuotesViewQuotesResource = selection.$$quotes}
		<ResourceBoundary
			resource={blockheadBridgeIntentBlockheadIntentQuotesViewQuotesResource}
		>
