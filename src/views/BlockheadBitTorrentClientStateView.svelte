...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.BlockheadBitTorrentClientState>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
	...
	{#snippet Details({ open: detailsOpen })}
		{#if detailsOpen}
			<BlockheadBitTorrentClientState_TimestampsView
				selection={selection[EntityProxyField]<EntityType.BlockheadBitTorrentClientState_Timestamp>('$$timestamps')}
				title='timestamps'
			...
			<BlockheadBitTorrentTransfer_TimestampsView
				selection={selection[EntityProxyField]<EntityType.BlockheadBitTorrentTransfer_Timestamp>('$$transfers')}
				title='transfers'
