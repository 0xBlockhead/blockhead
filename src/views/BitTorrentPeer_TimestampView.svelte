...
<script lang="ts">
	...
	let {
		...
		{
			selection: EntityProxyResource<typeof schema, EntityType.BitTorrentPeer_Timestamp>
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.BitTorrentPeer_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
