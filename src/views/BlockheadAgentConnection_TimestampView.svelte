...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyResource<EntityType.BlockheadAgentConnection_Timestamp>
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.BlockheadAgentConnection_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
	...
	const blockheadAgentConnectionTimestamp = $derived(selection({
		sources: [
