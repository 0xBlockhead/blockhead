...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.BlockheadLogosBlockchainNodeState>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
	...
	{#snippet Details({ open: detailsOpen })}
		{#if detailsOpen}
			<BlockheadLogosBlockchainNodeState_TimestampsView
				selection={selection[EntityProxyField]<EntityType.BlockheadLogosBlockchainNodeState_Timestamp>('$$timestamps')}
				title='timestamps'
