...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.HyperliquidFill>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
>
	...
	{#snippet Content({ open: contentOpen })}
		<dl data-column-item="center">
			...
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.HyperliquidOrder, false>('$order')}
			>
			...
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.HyperliquidTransaction, false>('$transaction')}
			>
