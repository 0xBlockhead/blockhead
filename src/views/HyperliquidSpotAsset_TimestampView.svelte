...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.HyperliquidSpotAsset_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
>
	{#snippet Title()}
		<ResourceBoundary resource={hyperliquidSpotAssetTimestamp}>
			{#snippet Pending()}
				{title || 'hyperliquid spot asset timestamp'}
			{/snippet}
