...
<script lang="ts">
	...
	let {
		...
		...EntityViewProps
	}: EntitySelectionViewProps<EntityType.BlockheadLogosBlockchainNodeState_Timestamp> = $props()
	...
	const titleFallback = $derived(String(pendingEntity.timestampMs ?? '') || 'blockhead Logos blockchain node state timestamp')
