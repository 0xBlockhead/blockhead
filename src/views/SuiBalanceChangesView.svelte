...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyEntitiesResource<EntityType.SuiBalanceChange>
			title?: string
...
>
	...
	{#snippet Item({ item: suiBalanceChange })}
		...
		{@const selection = select(EntityType.SuiBalanceChange, suiBalanceChange[EntityMetaKey.Selector], { sources: collectionSelection.sources })}
