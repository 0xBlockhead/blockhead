...
<script lang="ts">
	...
	let {
		...
		...EntityViewProps
	}: EntitySelectionViewProps<EntityType.BlockheadCashuProof_Timestamp> = $props()
	...
	const titleFallback = $derived(String(pendingEntity.timestampMs ?? '') || 'blockhead Cashu proof timestamp')
