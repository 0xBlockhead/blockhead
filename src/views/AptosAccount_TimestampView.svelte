...
<script lang="ts">
	...
	let {
		...
		...EntityViewProps
	}: EntitySelectionViewProps<EntityType.AptosAccount_Timestamp> = $props()
	...
	const titleFallback = $derived(String(pendingEntity.ledgerVersion ?? '') || 'aptos account timestamp')
