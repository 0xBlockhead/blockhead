...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyEntitiesResource<EntityType.TronAccount>
			title?: string
		...
		{#snippet children(tronAccounts)}
			...
			>
				...
				{#snippet Item({ item: tronAccount })}
					...
					{@const selection = select(EntityType.TronAccount, tronAccount[EntityMetaKey.Selector], { sources: collectionSelection.sources })}
					<TronAccountView
						selection={selection}
