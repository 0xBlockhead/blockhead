...
<script lang="ts">
	...
	let {
		...
		{
			selection: RegisteredEntityProxyResource<EntityType.Eip8004EndpointDomainVerification_Timestamp>
			prefetched?: Partial<RegisteredEntityProxyData<EntityType.Eip8004EndpointDomainVerification_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
