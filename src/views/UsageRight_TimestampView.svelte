...
<script lang="ts">
	...
	let {
	...
	}: WithRest<
		{
			...
			prefetched?: Partial<EntityProxyData<typeof schema, EntityType.UsageRight_Timestamp>>
			title?: string
			href?: string
			layout?: EntityLayout
			open?: boolean
...
>
	...
	{#snippet Content({ open: contentOpen })}
		...
		<dl data-column-item="center">
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.AssetObject, false>('$object')}
			>
			...
			<ResourceBoundary
				resource={selection[EntityProxyField]<EntityType.Account, false>('$user')}
			>
