...
const observationResolver = defineResolver({
			...
			totalLiquidityUSD: (snapshot) => snapshot.totalLiquidityUSD,
			activeLiquidityUSD: (snapshot) => snapshot.activeLiquidityUSD,
			uncollectedProtocolSideValueUSD: (snapshot) => snapshot.uncollectedProtocolSideValueUSD,
			uncollectedSupplySideValueUSD: (snapshot) => snapshot.uncollectedSupplySideValueUSD,
			protocolControlledValueUSD: (snapshot) => snapshot.protocolControlledValueUSD ?? undefined,
			...
			cumulativeUniqueLPs: (snapshot) => BigInt(snapshot.cumulativeUniqueLPs),
			cumulativeUniqueTraders: (snapshot) => BigInt(snapshot.cumulativeUniqueTraders),
			...
			openPositionCount: (snapshot) => BigInt(snapshot.openPositionCount),
			cumulativePositionCount: (snapshot) => BigInt(snapshot.cumulativePositionCount),
			lastSnapshotDayID: (snapshot) => BigInt(snapshot.lastSnapshotDayID),
			lastUpdateTimestamp: (snapshot) => BigInt(snapshot.lastUpdateTimestamp),
			lastUpdateBlockNumber: (snapshot) => BigInt(snapshot.lastUpdateBlockNumber),
		})
...
const poolObservationResolver = defineResolver({
  ...
  totalLiquidityUSD: result => result.pool.totalLiquidityUSD,
  activeLiquidityUSD: result => result.pool.activeLiquidityUSD,
  uncollectedProtocolSideValuesUSD: result => result.pool.uncollectedProtocolSideValuesUSD,
  uncollectedSupplySideValuesUSD: result => result.pool.uncollectedSupplySideValuesUSD,
  ...
  stakedOutputTokenAmount: result => result.pool.stakedOutputTokenAmount == null ? undefined : BigInt(result.pool.stakedOutputTokenAmount),
  rewardTokenEmissionsAmount: result => result.pool.rewardTokenEmissionsAmount?.map(BigInt) ?? [],
  rewardTokenEmissionsUSD: result => result.pool.rewardTokenEmissionsUSD ?? [],
  cumulativeDepositCount: result => BigInt(result.pool.cumulativeDepositCount),
  cumulativeWithdrawCount: result => BigInt(result.pool.cumulativeWithdrawCount),
  cumulativeSwapCount: result => BigInt(result.pool.cumulativeSwapCount),
  positionCount: result => BigInt(result.pool.positionCount),
  openPositionCount: result => BigInt(result.pool.openPositionCount),
  closedPositionCount: result => BigInt(result.pool.closedPositionCount),
  lastSnapshotDayID: result => BigInt(result.pool.lastSnapshotDayID),
  lastSnapshotHourID: result => BigInt(result.pool.lastSnapshotHourID),
  lastUpdateTimestamp: result => BigInt(result.pool.lastUpdateTimestamp),
  lastUpdateBlockNumber: result => BigInt(result.pool.lastUpdateBlockNumber),
