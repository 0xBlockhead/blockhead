...
export default {
	...
	label: 'hedera contract state timestamp',
	labelPlural: 'hedera contract state observations',
	selectors: [
		{
			name: HederaContractState_TimestampSelector.ContractSlotTimestampMsSource,
			fields: [
				'$contract',
				'slot',
				'timestampMs',
