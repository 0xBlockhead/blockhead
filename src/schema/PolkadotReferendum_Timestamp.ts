...
export default {
	...
	selectors: [
		{
			name: PolkadotReferendum_TimestampSelector.ReferendumTimestampMsSource,
			fields: [
				'$referendum',
				'timestampMs',
				'source',
	...
	fields: [
		...
		{
				name: 'confirmationStartedAtBlockNumber',
