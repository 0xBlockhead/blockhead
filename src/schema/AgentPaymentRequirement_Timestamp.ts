...
export enum AgentPaymentRequirement_TimestampSelector {
	SubjectKindSubjectSelectorPaymentProtocolTimestampMsSource = 'subjectKind+subjectSelector+paymentProtocol+timestampMs+source',
}
export default {
	...
	fields: [
		...
		},
		{
			...
			label: 'eip8004 service endpoint',
			type: EntityFieldType.EntityReference,
