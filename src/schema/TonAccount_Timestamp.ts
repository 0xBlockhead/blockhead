...
export enum TonAccount_TimestampSelector {
	AccountTimestampMsSource = 'AccountTimestampMsSource',
}
export default {
	entityType: EntityType.TonAccount_Timestamp,
	label: 'ton account timestamp',
	labelPlural: 'ton account observations',
	selectors: [
		{
			name: TonAccount_TimestampSelector.AccountTimestampMsSource,
			fields: [
				'$account',
				'timestampMs',
				'source',
