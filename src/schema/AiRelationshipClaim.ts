...
export enum AiRelationshipClaimSelector {
	SubjectKindSubjectSelectorRelationshipKindObjectKindObjectSelectorSourceTimestampMs = 'subjectKind+subjectSelector+relationshipKind+objectKind+objectSelector+source+timestampMs',
}
export default {
