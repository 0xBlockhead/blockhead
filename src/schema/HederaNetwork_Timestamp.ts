...
export default {
	...
	label: 'hedera network timestamp',
	labelPlural: 'hedera network observations',
	selectors: [
		{
			name: HederaNetwork_TimestampSelector.NetworkTimestampMsSource,
			fields: [
				'$network',
				'timestampMs',
				'source',
