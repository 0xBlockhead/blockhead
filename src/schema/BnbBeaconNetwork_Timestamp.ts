...
export default {
	...
	selectors: [
		{
			name: BnbBeaconNetwork_TimestampSelector.NetworkTimestampMsSource,
			fields: [
				'$network',
				'timestampMs',
				'source',
	...
	fields: [
		...
		{
				name: 'latestArchivedBlockTimeMs',
