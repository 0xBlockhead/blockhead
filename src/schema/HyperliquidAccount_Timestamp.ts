...
export enum HyperliquidAccount_TimestampSelector {
...
export default {
	...
	selectors: [
		{
			name: HyperliquidAccount_TimestampSelector.AccountTimestampMsSource,
			fields: [
				'$account',
				'timestampMs',
				'source',
	...
	fields: [
		...
		{
			name: 'crossMaintenanceMarginUsed',
