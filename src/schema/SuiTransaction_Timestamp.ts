...
export enum SuiTransaction_TimestampSelector {
	TransactionCheckpointSequenceSource = '$transaction+checkpointSequence+source',
}
export default {
	...
	selectors: [
		{
			name: SuiTransaction_TimestampSelector.TransactionCheckpointSequenceSource,
			fields: [
				'$transaction',
				'checkpointSequence',
				'source',
