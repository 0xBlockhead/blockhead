...
export default {
	...
	label: 'global you tube network timestamp',
	labelPlural: 'global you tube network observations',
	selectors: [
		{
	...
	fields: [
		...
		},
		{
			...
			label: 'source window video count',
			type: EntityFieldType.Primitive,
			primitiveType: type("number"),
			cardinality: EntityFieldCardinality.ZeroOrOne,
		},
		{
			...
			label: 'source window playlist count',
			type: EntityFieldType.Primitive,
			primitiveType: type("number"),
			cardinality: EntityFieldCardinality.ZeroOrOne,
		},
		...
		},
		{
			...
			label: 'local catalog video count',
			type: EntityFieldType.Primitive,
			primitiveType: type("number"),
			cardinality: EntityFieldCardinality.ZeroOrOne,
		},
		{
			...
			label: 'local catalog playlist count',
			type: EntityFieldType.Primitive,
			primitiveType: type("number"),
			cardinality: EntityFieldCardinality.ZeroOrOne,
		},
