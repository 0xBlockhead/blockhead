...
export enum AiProviderApiOperation_TimestampSelector {
	OperationTimestampMsSource = 'OperationTimestampMsSource',
}
export default {
	...
	selectors: [
		{
			name: AiProviderApiOperation_TimestampSelector.OperationTimestampMsSource,
			fields: [
				'$operation',
				'timestampMs',
				'source',
