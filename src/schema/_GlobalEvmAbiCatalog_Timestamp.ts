...
export default {
	...
	selectors: [
		{
			name: _GlobalEvmAbiCatalog_TimestampSelector.HubTimestampMsSource,
			fields: [
				'$hub',
				'timestampMs',
				'source',
	...
	fields: [
		...
		{
			name: 'sourceReportedSelectorCount',
		...
		{
			name: 'localCatalogSelectorCount',
			label: 'local catalog selector count',
			type: EntityFieldType.Primitive,
			primitiveType: type("number"),
			cardinality: EntityFieldCardinality.ZeroOrOne,
		},
		{
			name: 'localCatalogTopicCount',
			label: 'local catalog topic count',
			type: EntityFieldType.Primitive,
			primitiveType: type("number"),
			cardinality: EntityFieldCardinality.ZeroOrOne,
		},
		{
			name: 'localCatalogErrorCount',
			label: 'local catalog error count',
			type: EntityFieldType.Primitive,
			primitiveType: type("number"),
			cardinality: EntityFieldCardinality.ZeroOrOne,
		},
