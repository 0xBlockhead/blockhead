...
import AaveAccountMarket_TimestampSchema from '$/schema/AaveAccountMarket_Timestamp.ts'
...
import AaveReservePositionSchema from '$/schema/AaveReservePosition.ts'
...
import AtprotoFeedGeneratorSchema from '$/schema/AtprotoFeedGenerator.ts'
import AtprotoGraphListSchema from '$/schema/AtprotoGraphList.ts'
...
import AtprotoStarterPackSchema from '$/schema/AtprotoStarterPack.ts'
...
import BalancerAccountPoolBalanceSchema from '$/schema/BalancerAccountPoolBalance.ts'
import BalancerGaugeSchema from '$/schema/BalancerGauge.ts'
import BalancerPoolSchema from '$/schema/BalancerPool.ts'
import BalancerPoolAprItemSchema from '$/schema/BalancerPoolAprItem.ts'
import BalancerPoolEventSchema from '$/schema/BalancerPoolEvent.ts'
import BalancerPoolTokenSchema from '$/schema/BalancerPoolToken.ts'
import BalancerVeBalBalanceSchema from '$/schema/BalancerVeBalBalance.ts'
import BeaconAttestationSchema from '$/schema/BeaconAttestation.ts'
import BeaconBlock_TimestampSchema from '$/schema/BeaconBlock_Timestamp.ts'
import BeaconBlockSchema from '$/schema/BeaconBlock.ts'
import BeaconCommitteeSchema from '$/schema/BeaconCommittee.ts'
import BeaconDataColumn_TimestampSchema from '$/schema/BeaconDataColumn_Timestamp.ts'
import BeaconDataColumnSchema from '$/schema/BeaconDataColumn.ts'
import BeaconDepositSchema from '$/schema/BeaconDeposit.ts'
import BeaconEpochSchema from '$/schema/BeaconEpoch.ts'
import BeaconExecutionConsolidationRequestSchema from '$/schema/BeaconExecutionConsolidationRequest.ts'
import BeaconExecutionDepositRequestSchema from '$/schema/BeaconExecutionDepositRequest.ts'
import BeaconExecutionPayloadBidSchema from '$/schema/BeaconExecutionPayloadBid.ts'
import BeaconExecutionPayloadEnvelope_TimestampSchema from '$/schema/BeaconExecutionPayloadEnvelope_Timestamp.ts'
import BeaconExecutionPayloadEnvelopeSchema from '$/schema/BeaconExecutionPayloadEnvelope.ts'
import BeaconExecutionWithdrawalRequestSchema from '$/schema/BeaconExecutionWithdrawalRequest.ts'
...
import BitcoinMiningPool_TimestampSchema from '$/schema/BitcoinMiningPool_Timestamp.ts'
...
import BitcoinRuneBalanceSchema from '$/schema/BitcoinRuneBalance.ts'
import BitcoinRunestoneSchema from '$/schema/BitcoinRunestone.ts'
...
import BlockheadActionSchema from '$/schema/BlockheadAction.ts'
import BlockheadActionAuthorityRequestSchema from '$/schema/BlockheadActionAuthorityRequest.ts'
import BlockheadActionDispatchOccurrenceSchema from '$/schema/BlockheadActionDispatchOccurrence.ts'
...
import BlockheadLightningForwardSchema from '$/schema/BlockheadLightningForward.ts'
...
import BlockheadLightningPeer_TimestampSchema from '$/schema/BlockheadLightningPeer_Timestamp.ts'
...
import BlockheadSourceEndpoint_TimestampSchema from '$/schema/BlockheadSourceEndpoint_Timestamp.ts'
...
import CompoundPositionCollateralSchema from '$/schema/CompoundPositionCollateral.ts'
...
import CurveGaugeSchema from '$/schema/CurveGauge.ts'
import CurveLendingVaultSchema from '$/schema/CurveLendingVault.ts'
import CurvePoolSchema from '$/schema/CurvePool.ts'
import CurvePoolCoinSchema from '$/schema/CurvePoolCoin.ts'
...
import EulerEvkVaultPositionSchema from '$/schema/EulerEvkVaultPosition.ts'
...
import FilecoinMessage_TimestampSchema from '$/schema/FilecoinMessage_Timestamp.ts'
import FilecoinMessageSchema from '$/schema/FilecoinMessage.ts'
import FilecoinMessageEventSchema from '$/schema/FilecoinMessageEvent.ts'
import FilecoinMessageFeeSchema from '$/schema/FilecoinMessageFee.ts'
import FilecoinMessageReceiptSchema from '$/schema/FilecoinMessageReceipt.ts'
import FilecoinMessageSubcallSchema from '$/schema/FilecoinMessageSubcall.ts'
import FilecoinMessageTokenTransferSchema from '$/schema/FilecoinMessageTokenTransfer.ts'
import FilecoinMessageTransferSchema from '$/schema/FilecoinMessageTransfer.ts'
...
import FinancialProtocol_Amm_EvmBlockSchema from '$/schema/FinancialProtocol_Amm_EvmBlock.ts'
...
import GmxPositionSchema from '$/schema/GmxPosition.ts'
...
import LightningChannelRoutingPolicy_TimestampSchema from '$/schema/LightningChannelRoutingPolicy_Timestamp.ts'
...
import LiquidityPool_Amm_EvmBlock_InputAssetSchema from '$/schema/LiquidityPool_Amm_EvmBlock_InputAsset.ts'
...
import MorphoMarketPositionSchema from '$/schema/MorphoMarketPosition.ts'
import MorphoVaultSchema from '$/schema/MorphoVault.ts'
import MorphoVaultPositionSchema from '$/schema/MorphoVaultPosition.ts'
...
import PendlePositionSchema from '$/schema/PendlePosition.ts'
...
import XmtpMessageSchema from '$/schema/XmtpMessage.ts'
import XmtpNetworkSchema from '$/schema/XmtpNetwork.ts'
import XmtpParticipantSchema from '$/schema/XmtpParticipant.ts'
...
const schemaChunk0 = [
	...
	AaveAccountMarket_TimestampSchema,
	AaveMarketSchema,
	AaveReserveSchema,
	AaveReservePositionSchema,
	AccountSchema,
...
const schemaChunk2 = [
	...
	AtprotoFeedGeneratorSchema,
	AtprotoGraphListSchema,
	AtprotoNetworkSchema,
	AtprotoPostSchema,
	AtprotoPost_TimestampSchema,
	AtprotoRepoCommitSchema,
	AtprotoStarterPackSchema,
	AvailAppIdSchema,
...
const schemaChunk3 = [
	...
	BalancerPoolEventSchema,
	BalancerPoolTokenSchema,
	BalancerVeBalBalanceSchema,
	BeaconAttestationSchema,
	BeaconBlockSchema,
	BeaconBlock_TimestampSchema,
	BeaconCommitteeSchema,
	BeaconDataColumnSchema,
	BeaconDataColumn_TimestampSchema,
	BeaconDepositSchema,
	BeaconEpochSchema,
	BeaconExecutionConsolidationRequestSchema,
	BeaconExecutionDepositRequestSchema,
	BeaconExecutionPayloadBidSchema,
	BeaconExecutionPayloadEnvelopeSchema,
	BeaconExecutionPayloadEnvelope_TimestampSchema,
	BeaconExecutionWithdrawalRequestSchema,
	...
	BitcoinMiningPool_TimestampSchema,
	BitcoinOrdinalInscriptionSchema,
	BitcoinRuneSchema,
	BitcoinRuneBalanceSchema,
	BitcoinRunestoneSchema,
...
const schemaChunk4 = [
	...
	BlockheadActionSchema,
	BlockheadActionAuthorityRequestSchema,
	BlockheadActionDispatchOccurrenceSchema,
...
const schemaChunk5 = [
	...
	BlockheadLightningForwardSchema,
	...
	BlockheadLightningPeer_TimestampSchema,
...
const schemaChunk6 = [
	...
	BlockheadSourceEndpoint_TimestampSchema,
...
const schemaChunk8 = [
	...
	CompoundPositionCollateralSchema,
...
const schemaChunk11 = [
	...
	FilecoinMessage_TimestampSchema,
	FilecoinMessageEventSchema,
	FilecoinMessageFeeSchema,
	FilecoinMessageReceiptSchema,
	FilecoinMessageSubcallSchema,
	FilecoinMessageTokenTransferSchema,
	FilecoinMessageTransferSchema,
	FilecoinMinerSchema,
	...
	FinancialProtocol_Amm_EvmBlockSchema,
	GitBlobSchema,
	GitCommitSchema,
...
const schemaChunk14 = [
	...
	LightningChannelRoutingPolicy_TimestampSchema,
