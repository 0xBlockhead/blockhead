...
import _GlobalArweaveNetwork_TimestampSchema from '$/schema/_GlobalArweaveNetwork_Timestamp.ts'
...
import _GlobalFarcasterNetworkSchema from '$/schema/_GlobalFarcasterNetwork.ts'
import _GlobalFarcasterNetwork_TimestampSchema from '$/schema/_GlobalFarcasterNetwork_Timestamp.ts'
...
import _GlobalLensNetworkSchema from '$/schema/_GlobalLensNetwork.ts'
import _GlobalLensNetwork_TimestampSchema from '$/schema/_GlobalLensNetwork_Timestamp.ts'
...
import _GlobalRssNetworkSchema from '$/schema/_GlobalRssNetwork.ts'
import _GlobalRssNetwork_TimestampSchema from '$/schema/_GlobalRssNetwork_Timestamp.ts'
...
import _GlobalXNetwork_TimestampSchema from '$/schema/_GlobalXNetwork_Timestamp.ts'
...
import CardanoNetworkSchema from '$/schema/CardanoNetwork.ts'
...
import CosmosAccountBalance_TimestampSchema from '$/schema/CosmosAccountBalance_Timestamp.ts'
import CosmosBlockSchema from '$/schema/CosmosBlock.ts'
import CosmosContractSchema from '$/schema/CosmosContract.ts'
import CosmosDelegationSchema from '$/schema/CosmosDelegation.ts'
import CosmosDelegation_TimestampSchema from '$/schema/CosmosDelegation_Timestamp.ts'
...
import CosmosGovernanceProposalDepositSchema from '$/schema/CosmosGovernanceProposalDeposit.ts'
import CosmosGovernanceProposalDeposit_TimestampSchema from '$/schema/CosmosGovernanceProposalDeposit_Timestamp.ts'
import CosmosGovernanceProposalTally_TimestampSchema from '$/schema/CosmosGovernanceProposalTally_Timestamp.ts'
import CosmosGovernanceProposalVoteSchema from '$/schema/CosmosGovernanceProposalVote.ts'
import CosmosGovernanceProposalVote_TimestampSchema from '$/schema/CosmosGovernanceProposalVote_Timestamp.ts'
...
import HederaNetworkSchema from '$/schema/HederaNetwork.ts'
...
import HyperliquidSpotAsset_TimestampSchema from '$/schema/HyperliquidSpotAsset_Timestamp.ts'
...
import TonNetworkSchema from '$/schema/TonNetwork.ts'
...
import XrplNetworkSchema from '$/schema/XrplNetwork.ts'
import XrplNetwork_TimestampSchema from '$/schema/XrplNetwork_Timestamp.ts'
...
const schemaChunk6 = [
	...
	CosmosAccountBalance_TimestampSchema,
	CosmosBlockSchema,
	CosmosContractSchema,
	CosmosDelegationSchema,
	CosmosDelegation_TimestampSchema,
	CosmosDenomSchema,
	CosmosGovernanceProposalSchema,
	CosmosGovernanceProposal_TimestampSchema,
	CosmosGovernanceProposalDepositSchema,
	CosmosGovernanceProposalDeposit_TimestampSchema,
	CosmosGovernanceProposalTally_TimestampSchema,
	CosmosGovernanceProposalVoteSchema,
	CosmosGovernanceProposalVote_TimestampSchema,
	CosmosMessageSchema,
	CosmosModuleSchema,
	CosmosNetworkSchema,
...
type SchemaRegistry = readonly (
	| (typeof schemaChunk0)[number]
	| (typeof schemaChunk1)[number]
	| (typeof schemaChunk2)[number]
	| (typeof schemaChunk3)[number]
	| (typeof schemaChunk4)[number]
	| (typeof schemaChunk5)[number]
	| (typeof schemaChunk6)[number]
	| (typeof schemaChunk7)[number]
	| (typeof schemaChunk8)[number]
	| (typeof schemaChunk9)[number]
	| (typeof schemaChunk10)[number]
	| (typeof schemaChunk11)[number]
	| (typeof schemaChunk12)[number]
	| (typeof schemaChunk13)[number]
	| (typeof schemaChunk14)[number]
	| (typeof schemaChunk15)[number]
	| (typeof schemaChunk16)[number]
	| (typeof schemaChunk17)[number]
	| (typeof schemaChunk18)[number]
	| (typeof schemaChunk19)[number]
	| (typeof schemaChunk20)[number]
)[]

const schemaEntries: EntityDefinition[] = []
schemaEntries.push(...schemaChunk0)
schemaEntries.push(...schemaChunk1)
schemaEntries.push(...schemaChunk2)
schemaEntries.push(...schemaChunk3)
schemaEntries.push(...schemaChunk4)
schemaEntries.push(...schemaChunk5)
schemaEntries.push(...schemaChunk6)
schemaEntries.push(...schemaChunk7)
schemaEntries.push(...schemaChunk8)
schemaEntries.push(...schemaChunk9)
schemaEntries.push(...schemaChunk10)
schemaEntries.push(...schemaChunk11)
schemaEntries.push(...schemaChunk12)
schemaEntries.push(...schemaChunk13)
schemaEntries.push(...schemaChunk14)
schemaEntries.push(...schemaChunk15)
schemaEntries.push(...schemaChunk16)
schemaEntries.push(...schemaChunk17)
schemaEntries.push(...schemaChunk18)
schemaEntries.push(...schemaChunk19)
schemaEntries.push(...schemaChunk20)
