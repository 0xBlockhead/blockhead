...
>
	...
	>
		...
		<p id="open-entity-help">
			Supported identifiers: CAIP-2 networks, CAIP-10 accounts, HTTP(S) URLs, .eth names, @user@host ActivityPub handles, AT Protocol post URIs, IPFS/IPNS URIs, and magnet URIs.
		</p>
