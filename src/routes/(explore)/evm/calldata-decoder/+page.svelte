						...
						{#if selector && normalizedSelector}
							<li>
									<EntityView
										...
										href={resolve('/(explore)/(evm)/(selectors)/selector/[hex]', {
									...
									{#snippet Title()}
										...
										>
												{#snippet children(row)}
													<Heading>
														<a href={resolve('/(explore)/(evm)/(selectors)/selector/[hex]', {
															hex: normalizedSelector,
														})}>
						...
						{#if topic && normalizedTopic}
							<li>
									<EntityView
										...
										href={resolve('/(explore)/(evm)/(topics)/topic/[hex]', {
											hex: normalizedTopic,
										})}
									>
									{#snippet Icon()}
									...
									{#snippet Title()}
										...
										>
												{#snippet children(row)}
													<Heading>
														<a href={resolve('/(explore)/(evm)/(topics)/topic/[hex]', {
															hex: normalizedTopic,
														})}>
