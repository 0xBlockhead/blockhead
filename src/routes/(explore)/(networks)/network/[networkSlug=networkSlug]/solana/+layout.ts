...
// Route surface eligibility: requiredProjections=[['Solana']]
export const load: LayoutLoad = ({ params }) => {
	...
	if (!((routeSurfaceNetwork.executionModels !== undefined && routeSurfaceNetwork.executionModels.some((value: string | number | boolean | null) => value === 'SolanaRuntime')))) error(404, 'Network facet not available')
