...
export const load: PageLoad = async ({ params, parent }) => {
	...
	if (!((projectionNetwork.namespace === 'Xrpl' && projectionNetwork.namespace === 'Xrpl') && matchStringSegment(params.account) && matchStringSegment(params.currency) && matchStringSegment(params.issuer))) error(404, 'Route mapping not applicable')
