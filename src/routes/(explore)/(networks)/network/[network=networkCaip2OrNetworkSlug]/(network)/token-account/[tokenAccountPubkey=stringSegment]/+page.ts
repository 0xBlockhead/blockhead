...
export const load: PageLoad = async ({ params, parent }) => {
	...
	if (!((projectionNetwork.executionModels !== undefined && projectionNetwork.executionModels.some((value: string | number | boolean | null) => value === 'SolanaRuntime')) && matchStringSegment(params.tokenAccountPubkey))) error(404, 'Route mapping not applicable')
	...
	if (solanaTokenAccountNetworkTokenAccountPubkeySelector instanceof arktype.errors) error(404, 'Invalid SolanaTokenAccount selector')
