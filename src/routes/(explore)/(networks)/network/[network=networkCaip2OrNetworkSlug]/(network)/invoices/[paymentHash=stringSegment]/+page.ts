...
export const load: PageLoad = async ({ params, parent }) => {
	...
	const blockheadLightningInvoiceNetworkPaymentHashSelector = parseEntitySelector(
		schema,
	...
	if (blockheadLightningInvoiceNetworkPaymentHashSelector instanceof arktype.errors) error(404, 'Invalid BlockheadLightningInvoice selector')
