...
export const load: PageLoad = async ({ params, parent }) => {
	...
	if (!((projectionNetwork.executionModels !== undefined && projectionNetwork.executionModels.some((value: string | number | boolean | null) => value === 'ZcashShielded')) && matchStringSegment(params.pool))) error(404, 'Route mapping not applicable')
	...
	if (zcashShieldedPoolNetworkPoolSelector instanceof arktype.errors) error(404, 'Invalid ZcashShieldedPool selector')
