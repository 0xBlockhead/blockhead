...
<script lang="ts">
	...
	const pageSelection = $derived(data?.selector == null ? undefined : select(EntityType.HyperliquidBorrowLendPosition, {
	...
	import HyperliquidBorrowLendPositionView from '$/views/HyperliquidBorrowLendPositionView.svelte'
</script>
