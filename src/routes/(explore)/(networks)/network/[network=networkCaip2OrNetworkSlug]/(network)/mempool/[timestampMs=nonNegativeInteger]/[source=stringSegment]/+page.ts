...
export const load: PageLoad = async ({ params, parent }) => {
	...
	const evmNetworkTxpoolTimestampNetworkTimestampMsSourceSelector = parseEntitySelector(
		schema,
	...
	if (evmNetworkTxpoolTimestampNetworkTimestampMsSourceSelector instanceof arktype.errors) error(404, 'Invalid EvmNetwork_Txpool_Timestamp selector')

	return {
		selector: evmNetworkTxpoolTimestampNetworkTimestampMsSourceSelector,
	}
}
