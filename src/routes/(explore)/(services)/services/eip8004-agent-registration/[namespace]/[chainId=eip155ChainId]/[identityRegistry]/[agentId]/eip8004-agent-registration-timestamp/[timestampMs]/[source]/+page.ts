...
import EntitySchema from '$/schema/Eip8004AgentRegistration_Timestamp.ts'
...
export const load: PageLoad = ({ params }) => {
	...
	if (selector instanceof arktype.errors) error(404, 'Invalid Eip8004AgentRegistration_Timestamp selector')
