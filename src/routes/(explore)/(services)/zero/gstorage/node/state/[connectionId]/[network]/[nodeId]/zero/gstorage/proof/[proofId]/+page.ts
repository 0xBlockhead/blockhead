...
import EntitySchema from '$/schema/BlockheadZeroGStorageProof.ts'
...
export const load: PageLoad = ({ params }) => {
	...
	if (selector instanceof arktype.errors) error(404, 'Invalid BlockheadZeroGStorageProof selector')
