...
import EntitySchema from '$/schema/AiRelationshipClaim.ts'
...
export const load: PageLoad = ({ params }) => {
	const selector = parseEntitySelector(
		...
		EntitySchema,
		{
			...
			relationshipKind: decodeURIComponent(params.relationshipKind),
	...
	if (selector instanceof arktype.errors) error(404, 'Invalid AiRelationshipClaim selector')
