...
import EntitySchema from '$/schema/A2aAgentService_Timestamp.ts'
...
export const load: PageLoad = ({ params }) => {
	...
	if (selector instanceof arktype.errors) error(404, 'Invalid A2aAgentService_Timestamp selector')
