...
<script lang="ts">
	...
	const pageEntityTitle = $derived((pageSelection.entity == null ? 'EVM selector observation' : 'EVM selector observation'))
...
<svelte:head>
	<title>{pageEntityTitle} • EVM selector observation • Blockhead</title>
</svelte:head>
