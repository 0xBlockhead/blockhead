...
test('queryResource maps TanStack DB snapshots to SvelteKit resource promise state', async ({ page }) => {
	...
	await expect(page.getByTestId('adapter-direct-current')).toHaveText('')
	await expect(page.getByTestId('adapter-direct-loading')).toHaveText('true')
	await expect(page.getByTestId('adapter-direct-ready')).toHaveText('false')
	await expect(page.getByTestId('adapter-direct-error')).toHaveText('')
	...
	await expect(page.getByTestId('adapter-direct-current')).toHaveText('Ready value')
	await expect(page.getByTestId('adapter-direct-loading')).toHaveText('false')
	await expect(page.getByTestId('adapter-direct-ready')).toHaveText('true')
	await expect(page.getByTestId('adapter-direct-error')).toHaveText('')
	...
	await expect(page.getByTestId('adapter-awaited-second')).toHaveText('Ready value')
	await expect(page.getByTestId('adapter-catch')).toHaveText('')
	await expect(page.getByTestId('adapter-finally-count')).toHaveText('2')
	await expect(page.getByTestId('adapter-direct-current')).toHaveText('Ready value')
	await expect(page.getByTestId('adapter-direct-loading')).toHaveText('true')
	await expect(page.getByTestId('adapter-direct-ready')).toHaveText('true')
	await expect(page.getByTestId('adapter-direct-error')).toHaveText('')
	...
	await expect(page.getByTestId('adapter-direct-current')).toHaveText('Refreshed value')
	await expect(page.getByTestId('adapter-direct-loading')).toHaveText('false')
	await expect(page.getByTestId('adapter-direct-ready')).toHaveText('true')
	await expect(page.getByTestId('adapter-direct-error')).toHaveText('')
	...
	await expect(page.getByTestId('adapter-direct-loading')).toHaveText('false')
	await expect(page.getByTestId('adapter-direct-ready')).toHaveText('true')
	await expect(page.getByTestId('adapter-direct-error')).toHaveText('Adapter failure')

	await page.getByTestId('adapter-recover-loading-button').click()
	await expect(page.getByTestId('adapter-awaited')).toHaveText('Adapter failure')
	await expect(page.getByTestId('adapter-awaited-second')).toHaveText('Adapter failure')
	await expect(page.getByTestId('adapter-catch')).toHaveText('Adapter failure')
	await expect(page.getByTestId('adapter-finally-count')).toHaveText('5')
	await expect(page.getByTestId('adapter-direct-current')).toHaveText('Refreshed value')
	await expect(page.getByTestId('adapter-direct-loading')).toHaveText('true')
	await expect(page.getByTestId('adapter-direct-ready')).toHaveText('true')
	await expect(page.getByTestId('adapter-direct-error')).toHaveText('')
	...
	await expect(page.getByTestId('adapter-direct-current')).toHaveText('Recovered value')
	await expect(page.getByTestId('adapter-direct-loading')).toHaveText('false')
	await expect(page.getByTestId('adapter-direct-ready')).toHaveText('true')
	await expect(page.getByTestId('adapter-direct-error')).toHaveText('')
	expectNoWarnings()
