...
import EntitySchema from '$/schema/Market_Derivative_Timestamp.ts'
...
export const load: PageLoad = ({ params }) => {
	...
	if (selector instanceof arktype.errors) error(404, 'Invalid Market_Derivative_Timestamp selector')
