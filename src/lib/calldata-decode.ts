...
export const parseFunctionSignature = (sig: string): { name: string, types: string[] } | null => {
...
export const decodeLogWithContractAbiJson = (
	...
	for (const entry of parsed) {
		...
		const signature = abiEventSignatureFromAbiEntry(entry as {
			name: string
...
export const formatDecodedParamValue = (type: string, value: unknown): string => {
