export interface paths {
    ...
    "/addresses/{kaspaAddress}/balance/{day_or_month}": {
        ...
        /**
         * EXPERIMENTAL - EXPECT BREAKING CHANGES: Get balance history for Kaspa addresses
         * @description Get balance history for address, only available for larger addresses.
         */
        get: operations["get_balance_history_for_kaspa_address_addresses__kaspaAddress__balance__day_or_month__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/addresses/utxos": {
         ...
         * @description Lists all open utxo for a given list of kaspa addresses.
         *
    ...
    "/addresses/{kaspaAddress}/utxos/count": {
         ...
         * @description Returns the number of open UTXOs for a given kaspa address
         */
        get: operations["get_utxo_count_for_address_addresses__kaspaAddress__utxos_count_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/blocks-from-bluescore": {
         ...
         * @description Lists blocks based on blueScore. Exactly one of blueScore, blueScoreGte, or blueScoreLt must be provided.
         */
    ...
    "/transactions/acceptance": {
         ...
         * @description Given a list of transaction_ids, return whether each one is accepted and the accepting blue score and timestamp.
         */
    ...
    "/addresses/active/count/": {
        ...
        /** EXPERIMENTAL - EXPECT BREAKING CHANGES: Get the total count of active addresses */
        get: operations["get_addresses_active_count_totals_addresses_active_count__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/addresses/active/count/{day_or_month}": {
        ...
        /** EXPERIMENTAL - EXPECT BREAKING CHANGES: Get the count of active addresses for a specific UTC day (YYYY-MM-DD) or month (YYYY-MM) */
        get: operations["get_addresses_active_count_for_day_addresses_active_count__day_or_month__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/info/hashrate/history/{day_or_month}": {
        ...
        /**
         * Get Hashrate History For Day Or Month
         * @description Get hashrate history for a specific UTC day (YYYY-MM-DD) or month (YYYY-MM)
         */
        get: operations["get_hashrate_history_for_day_or_month_info_hashrate_history__day_or_month__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/transactions/count/": {
        ...
        get: operations["get_transaction_count_totals_transactions_count__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/transactions/count/{day_or_month}": {
        ...
        /** EXPERIMENTAL - EXPECT BREAKING CHANGES: Get the number of accepted transactions for a specific UTC day (YYYY-MM-DD) or month (YYYY-MM) */
        get: operations["get_transaction_count_for_day_transactions_count__day_or_month__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        BlockTxOutputModel: {
            ...
            covenant?: components["schemas"]["BlockTxOutputCovenantModel"];
        };
...
export interface operations {
    ...
    get_balance_history_for_kaspa_address_addresses__kaspaAddress__balance__day_or_month__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AddressBalanceHistory"][];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    get_utxo_count_for_address_addresses__kaspaAddress__utxos_count_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["UtxoCountResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    get_addresses_active_count_totals_addresses_active_count__get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AddressesActiveCountResponse"];
                };
            };
        };
    };
    get_addresses_active_count_for_day_addresses_active_count__day_or_month__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    get_hashrate_history_for_day_or_month_info_hashrate_history__day_or_month__get: {
        parameters: {
            query?: {
                resolution?: "15m" | "1h";
            };
    ...
    get_transaction_count_totals_transactions_count__get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["TransactionCountResponse"];
                };
            };
        };
    };
    get_transaction_count_for_day_transactions_count__day_or_month__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
