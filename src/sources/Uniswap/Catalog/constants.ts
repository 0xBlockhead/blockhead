...
export const uniswapV3DeploymentsByNonfungiblePositionManagerAddress = Object.groupBy(
	uniswapV3Deployments,
	(deployment) => deployment.nonfungiblePositionManagerAddress
)


export const uniswapV3FeeTierByFee = Object.fromEntries(
