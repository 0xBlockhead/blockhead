export interface paths {
    ...
    "/eth/v1/beacon/states/{state_id}/builders": {
         ...
         */
        post: operations["getStateBuilders"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/eth/v1/validator/beacon_committee_subscriptions": {
         ...
         *
         *     Beacon nodes SHOULD use the set of validators that have submitted subscriptions via this
         *     endpoint to determine which validators are using the node for duties and to calculate the
         *     node's required custody group count (CGC). Validator clients SHOULD submit one entry per
         *     attached active validator per attestation duty, including when multiple validators share
         *     the same `(slot, committee_index)`, so the beacon node tracks every attached validator
         *     rather than only one per subnet.
         */
    ...
    "/eth/v1/validator/prepare_beacon_proposer": {
         ...
         * @deprecated
         * @description Deprecated from Gloas onwards in favor of
    ...
    "/eth/v1/validator/register_validator": {
         ...
         * @deprecated
         * @description Deprecated from Gloas onwards. Under Gloas, proposer fee recipient and gas limit preferences
         *     are expressed via `POST /eth/v1/validator/proposer_preferences` instead. Beacon node support
         *     for this endpoint pre-Gloas is REQUIRED; post-Gloas support is OPTIONAL and the endpoint
         *     MAY be removed.
         *
    ...
    "/eth/v1/validator/proposer_preferences": {
         ...
         * @description Verifies given signed proposer preferences and publishes them on the `proposer_preferences`
         *     gossipsub topic.
         *
         *     Notes:
         ...
         */
        post: operations["submitProposerPreferences"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/eth/v1/validator/execution_payload_envelopes/{slot}/{beacon_block_root}": {
         ...
         */
        get: operations["getExecutionPayloadEnvelope"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        BuilderResponse: {
            ...
            index: components["schemas"]["Uint64"];
            status: components["schemas"]["BuilderStatus"];
         ...
         * @enum {unknown}
         */
        BuilderStatus: "pending" | "active" | "exited";
        ...
        "Gloas.Builder": components["schemas"]["Builder"];
        "Gloas.BlockContents": components["schemas"]["Gloas-BlockContents"];
        ...
        "Gloas.ProposerPreferences": components["schemas"]["ProposerPreferences"];
        "Gloas.SignedProposerPreferences": components["schemas"]["SignedProposerPreferences"];
        ...
        /**
         * @description Signed execution payload envelope bundled with blobs and KZG proofs for stateless
        ...
        SignedExecutionPayloadEnvelopeContents: {
            signed_execution_payload_envelope: components["schemas"]["SignedExecutionPayloadEnvelope"];
            kzg_proofs: components["schemas"]["KZGProofs"];
            blobs: components["schemas"]["Blobs"];
        };
        /**
         ...
         */
        "Gloas-BlockContents": {
            block: components["schemas"]["Gloas-BeaconBlock"];
            execution_payload_envelope: components["schemas"]["ExecutionPayloadEnvelope"];
            kzg_proofs: components["schemas"]["KZGProofs"];
            blobs: components["schemas"]["Blobs"];
        };
        ...
        ProposerPreferences: {
            ...
            proposal_slot: components["schemas"]["Uint64"];
            ...
            target_gas_limit: components["schemas"]["Uint64"];
        };
    ...
    headers: {
        ...
        /** @description Indicates whether the execution payload envelope, blobs, and KZG proofs are included in the response. Required in response so client can deserialize returned data. */
        "Eth-Execution-Payload-Included": boolean;
        /**
         * @description Execution payload value in Wei. Required in response so client can determine relative value
         *     of execution payloads.
         */
...
export interface operations {
    ...
    getStateBuilders: {
        ...
        /**
         * @description The lists of builder IDs and statuses to filter on.
        ...
        requestBody?: {
            content: {
                "application/json": {
                    /**
                     * @description An array of values, with each value either a hex encoded public key (any bytes48 with 0x prefix) or a builder index.
                     *
                     *     If the supplied list is empty (i.e. the value is `[]`) or the property is omitted then all builders will be returned.
                     */
                    ids?: string[];
                    /**
                     * @description An array of builder statuses to filter on.
                     *
                     ...
                     */
                    statuses?: components["schemas"]["BuilderStatus"][];
                };
            };
        };
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        execution_optimistic: components["schemas"]["ExecutionOptimistic"];
                        finalized: components["schemas"]["Finalized"];
                        data: components["schemas"]["BuilderResponse"][];
                    };
                };
            };
    ...
    publishExecutionPayloadEnvelope: {
        parameters: {
            query?: {
                /**
                 * @description Level of validation that must be applied to an envelope before it is broadcast.
                 *
                 *     Possible values:
                 *     - **`gossip`** (default): lightweight gossip checks only
                 *     - **`consensus`**: full consensus checks, including validation of all signatures and
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        ...
                        data: components["schemas"]["Gloas-BeaconBlock"] | components["schemas"]["Gloas-BlockContents"];
                    };
                    "application/octet-stream": unknown;
                };
            };
    ...
    submitProposerPreferences: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SignedProposerPreferences"][];
                "application/octet-stream": unknown;
            };
        };
        responses: {
    ...
    getExecutionPayloadEnvelope: {
        parameters: {
            ...
            path: {
                ...
                slot: components["schemas"]["Uint64"];
                /**
                 * @description Root of the beacon block associated with this execution payload envelope. The beacon
                 *     node will verify that the cached envelope matches the given block root, returning a
                 *     404 if there is no match. Requiring the block root makes the lookup re-org resistant:
                 *     if a re-org occurs between block production and envelope retrieval, the validator client
                 *     will receive a 404 rather than an envelope committed to a stale block.
                 */
                beacon_block_root: components["schemas"]["Root"];
            };
            cookie?: never;
    ...
    eventstream: {
        parameters: {
            query: {
                ...
                topics: ("head" | "head_v2" | "block" | "block_gossip" | "attestation" | "single_attestation" | "voluntary_exit" | "bls_to_execution_change" | "proposer_slashing" | "attester_slashing" | "finalized_checkpoint" | "chain_reorg" | "contribution_and_proof" | "light_client_finality_update" | "light_client_optimistic_update" | "payload_attributes" | "data_column_sidecar" | "execution_payload" | "execution_payload_gossip" | "execution_payload_available" | "execution_payload_bid" | "payload_attestation_message" | "fast_confirmation" | "proposer_preferences")[];
            };
            header?: never;
            path?: never;
            cookie?: never;
