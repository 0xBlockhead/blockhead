...
export const acrossDepositDetailResponseEnvelope = arktype({
	deposit: acrossDepositEnvelope.omit(
		...
		'depositTxnRef?': 'string | undefined',
		'depositTxHash?': 'string | undefined',
		'fillTxnRef?': 'string | null | undefined',
		'fillTx?': 'string | null | undefined',
		'depositRefundTxnRef?': 'string | null | undefined',
		'depositRefundTxHash?': 'string | null | undefined',
		'speedups?': 'object[] | undefined',
	}),
	pagination: {
		currentIndex: 'number',
		maxIndex: 'number',
