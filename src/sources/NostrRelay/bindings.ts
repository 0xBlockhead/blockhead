	...
	[Source.NostrRelay_Nip11_Http]: [
		{
			...
			proxyId: '["NostrRelay_Nip11_Http","Feed","wss://relay.damus.io","HttpProxy","NostrRelay"]',
		...
		},
		{
			...
			delivery: SourceDelivery.HttpProxy,
			credentials: nostrRelayNip11HttpCredentials,
			proxyId: '["NostrRelay_Nip11_Http","Feed","wss://nos.lol","HttpProxy","NostrRelay"]',
			artifacts: nostrRelayNip11HttpArtifacts,
		},
		{
			source: Source.NostrRelay_Nip11_Http,
			...
			delivery: SourceDelivery.HttpProxy,
			credentials: nostrRelayNip11HttpCredentials,
			proxyId: '["NostrRelay_Nip11_Http","Feed","wss://relay.primal.net","HttpProxy","NostrRelay"]',
			artifacts: nostrRelayNip11HttpArtifacts,
		},
	],
