...
const voltaireJsonRpcTargets10Through480 = [
	{
		key: '10',
...
const voltaireJsonRpcTargets998Through999 = [
	{
		key: '998',
...
const voltaireJsonRpcTargets1301Through4801 = [
	{
		key: '1301',
...
const voltaireJsonRpcTargets10143Through11155420 = [
	{
		key: '10143',
...
export default indexSourceBindings([
	...
	...voltaireJsonRpcTargets10Through480.flatMap(({
		key,
		httpProxyLocator,
		remoteLiveLocator,
	}) => ([
	...
	...voltaireJsonRpcTargets998Through999.flatMap(({
		key,
	...
	...voltaireJsonRpcTargets1301Through4801.flatMap(({
		key,
		httpProxyLocator,
		remoteLiveLocator,
	}) => ([
	...
	...voltaireJsonRpcTargets10143Through11155420.flatMap(({
		key,
		httpProxyLocator,
		remoteLiveLocator,
	}) => ([
