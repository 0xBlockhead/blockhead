...
- A next-work decision uses primary, current-enough evidence; serializes only demonstrated collisions or measured limits; accounts for every ready outcome without emitting a backlog; bounds enabling machinery by the nearest outcome; resolves tentative premises before bundling dependent work; and verifies the claimed mechanism against a plausible substitute or fallback.
