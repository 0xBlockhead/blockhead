...
- A next-work decision uses primary, current-enough evidence; keeps independent work concurrent while naming only the colliding operation; bounds enabling machinery by the nearest outcome; resolves tentative ownership, location, authority, or mechanism before bundling dependent work; and verifies the claimed mechanism against a plausible substitute or fallback.
